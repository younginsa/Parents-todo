...
원문: 🌈Sentence of the day : Grasslands are covered with grass and has few trees.\nTheme과 관련된 문장이니 집에서 여러 번 연습해볼 수 있도록 도와주세요.
출력 referenceItems: { title: "Sentence of the day", date: "<baseDate>", category: "learning", content: "Grasslands are covered with grass and has few trees." }
출력 tasks: { title: "Sentence of the day 집에서 연습", date: "<baseDate>", category: "homework" }

예시 2 — Sentence of the day만 있고 안내 없는 경우:
원문: 🌈Sentence of the day : Hurricanes are big storms in the ocean.
출력 referenceItems만 추가: { title: "Sentence of the day", date: "<baseDate>", category: "learning", content: "Hurricanes are big storms in the ocean." }
